...
<body class="min-h-screen bg-gray-50">
                    ...
                    <form onsubmit="ajouterFondFinancier(); return false;" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="form-control">
                               ...
                               <input class="input input-bordered w-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="number" step="0.01" inputmode="decimal" id="solde_initiale" ... />
                        </div>
                    ...
                    <div class="table-container">
                        <table class="table-auto w-full table-zebra">
                            <thead class="bg-gray-100">
                                <tr>
                                    <th class="px-4 py-3 text-left text-gray-700 font-medium">Mois & Année</th>
    ...
    <script>
        ...
        function ajouterFondFinancier() {
            ...
            if (!date || !initiale || isNaN(initiale) || initiale < 0) {
        ...
        function chargerFonds() {
            ajax("GET", "/fond-financier", null, function (fonds) {
                ...
                fonds.forEach(f => {
                    ...
                    const dateObj = new Date(f.date_creation);
                    ...
                    row.innerHTML = `
                        <td class="px-4 py-3 text-gray-700">${mois} ${annee}</td>
        ...
        // Charger les fonds financiers au chargement de la page
        chargerFonds();
    </script>
</body>
</html>
